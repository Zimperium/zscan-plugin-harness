...
server_url=${PLUGIN_SERVER_URL:-https://zc202.zimperium.com}
client_id=${PLUGIN_CLIENT_ID:-}
secret=${PLUGIN_CLIENT_SECRET:-}
team_name=${PLUGIN_TEAM_NAME:-Default}
input_file=${PLUGIN_INPUT_FILE:-$1}
report_format=${PLUGIN_REPORT_FORMAT:-json}
